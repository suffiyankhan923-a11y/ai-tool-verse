...
-- Generated: 2026-08-18T11:05:22.294Z
-- Total Categories: 12
...
VALUES
('calculators', 'Calculators', 'calculators', 'Everyday math, age, discount, tip, percentage, and date calculators with instant accurate results.', 'Calculator', 'from-amber-500/20 to-yellow-600/20 text-amber-500'),
('converters', 'Converters', 'converters', 'Comprehensive unit converters for length, weight, temperature, currency, area, volume, and data.', 'ArrowLeftRight', 'from-blue-500/20 to-indigo-600/20 text-blue-400'),
('text-tools', 'Text Tools', 'text-tools', 'Transform, analyze, count, format, deduplicate, and clean up your text effortlessly.', 'Type', 'from-emerald-500/20 to-teal-600/20 text-emerald-400'),
('image-tools', 'Image Tools', 'image-tools', 'Client-side image compression, resizing, cropping, and format conversion with zero upload latency.', 'Image', 'from-purple-500/20 to-pink-600/20 text-purple-400'),
('developer-tools', 'Developer Tools', 'developer-tools', 'Fast JSON formatters, Base64 converters, UUID generators, hashers, and web encoding utilities.', 'Code2', 'from-cyan-500/20 to-blue-600/20 text-cyan-400'),
('seo-tools', 'SEO Tools', 'seo-tools', 'Generate meta tags, robots.txt, sitemaps, Open Graph cards, SERP previews, and check keyword density.', 'SearchCheck', 'from-orange-500/20 to-amber-600/20 text-orange-400'),
('finance-tools', 'Finance Tools', 'finance-tools', 'Mortgage, loan, compound interest, salary, profit margin, and investment growth estimators.', 'Coins', 'from-yellow-500/20 to-amber-600/20 text-yellow-500'),
('date-time', 'Date & Time Tools', 'date-time', 'Time difference, date arithmetic, workday counters, and multi-timezone schedulers.', 'CalendarClock', 'from-sky-500/20 to-indigo-600/20 text-sky-400'),
('productivity', 'Productivity Tools', 'productivity', 'Pomodoro focus timer, stopwatch, habit tracker, random decision maker, and quick scratchpad.', 'Flame', 'from-rose-500/20 to-red-600/20 text-rose-400'),
('health', 'Health & Fitness', 'health', 'BMI, BMR, TDEE, calorie target, ideal weight, body fat, and running pace calculators.', 'HeartPulse', 'from-green-500/20 to-emerald-600/20 text-green-400'),
('generators', 'Generators', 'generators', 'High-entropy password, QR code, random name, color palette, and CSS gradient generators.', 'Sparkles', 'from-violet-500/20 to-indigo-600/20 text-violet-400'),
('file-tools', 'File Tools', 'file-tools', 'Client-side file size converters, text file merge/splitter, and CSV-to-JSON format tools.', 'Files', 'from-slate-500/20 to-zinc-600/20 text-slate-400')
